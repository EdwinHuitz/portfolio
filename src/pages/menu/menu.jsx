...
export default function Menu(){
   ...
   let arr=[[0,"Pancakes"],[0,"Waffles"],[0,"Omelette"],[0,"Biscuits and Gravy"],[0,"Eggs Benedict"],[0,"Hashbrown"],[1,"Loaded Fries"],[1,"Bacon Cheeseburger"],[1,"Reuben Sandwich"],[2,"Milkshake"],[2,"Iced-Tea"],[2,"Coffee"]];
   let path="assets/img/food/"
   function menuItems(foodType,foodName){
      let newPath = path+foodName+".jpg"
         return (<>
